...
// Menu
// ================================================================================================================
export function AlurakutMenu({ myUser }) {
  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      ...
      <AlurakutMenuProfileSidebar myUser={myUser} />
...
function AlurakutMenuProfileSidebar({ myUser }) {
  return (
    <div className="alurakutMenuProfileSidebar">
      <div>
        <img src={`https://github.com/${myUser}.png`} style={{ borderRadius: '8px' }} />
        <hr />
        <p>
          <a className="boxLink" href={`/user/${myUser}`}>
            @{myUser}
          </a>
        </p>
        <hr />
